...
impl JavaCatalog {
    ...
    pub fn recommend(&self, minecraft_major: u32) -> JavaInstallation {
        ...
        let target = match minecraft_major {
            0..=16 => 8,  // Pre-1.17, Java 8
            17 => 16,     // 1.17 wants Java 16
            18..=20 => 17,// 1.18-1.20.4 want Java 17
            _ => 21,      // 1.20.5+ wants Java 21
        };
        // Prefer the highest version >= target. Otherwise the highest available.
